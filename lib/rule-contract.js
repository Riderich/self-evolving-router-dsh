...
export const KERNEL_HASH = createHash('sha256').update([
  './v2/core.js','./v2/development.js','./v2/plugin.js','./v2/runner.js',
  ...
  './rule-history.js', './rule-examples.js', './maintenance-state.js', './maintenance-controller.js', './maintenance-plugin.js',
